    ...
    Else
        ...
        Else
            ...
            If oInspector.IsWordMail Then
                ...
                Set oDoc = oInspector.WordEditor 'returns a document
                ...
                'is this an object? can i loop over the words?
                ...
                For Each w In oDoc.content.Words
                        ...
                        'if the window is in plaintext this wont work, i need it as html
                        With w.Font
                            .size = size
                            .Name = names(index)
                            .Color = hslToRgb(hue, sat, lum) 'textcolor to color textColor works for html but not plaintext, isnt that weird
                       End With
